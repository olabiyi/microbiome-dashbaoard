...
General Information {data-orientation=columns}
=====================================
...
Alpha Tables {data-orientation=columns}
=====================================
...
Abundance heatmaps {data-orientation=columns}
=====================================
...
```{r}
taxon_table <- taxon_tables$Phylum[, sample_order]
...
```{r}
taxon_table <- taxon_tables$Class[, sample_order]
mat2plot <-  pavian::normalize(taxon_table)
mat2plot <- remove_rare_features(feature_table = mat2plot[, sample_order],
                                 cut_off_percent = 1/100, by_sample = FALSE)
...
```{r}
taxon_table <- taxon_tables$Order[, sample_order]
mat2plot <-  pavian::normalize(taxon_table)
mat2plot <- remove_rare_features(feature_table = mat2plot[, sample_order],
                                 cut_off_percent = 1/100, by_sample = FALSE)
...
```{r}
taxon_table <- taxon_tables$Family[, sample_order]
mat2plot <-  pavian::normalize(taxon_table)
mat2plot <- remove_rare_features(feature_table = mat2plot[, sample_order],
                                 cut_off_percent = 1/100, by_sample = FALSE)
...
```{r}
taxon_table <- taxon_tables$Genus[, sample_order]
mat2plot <-  pavian::normalize(taxon_table)
mat2plot <- remove_rare_features(feature_table = mat2plot[, sample_order],
                                 cut_off_percent = 1/100, by_sample = FALSE)
...
```{r}
taxon_table <- taxon_tables$Species[, sample_order]
mat2plot <-  pavian::normalize(taxon_table)
mat2plot <- remove_rare_features(feature_table = mat2plot[, sample_order],
                                 cut_off_percent = 1/100, by_sample = FALSE)
...
Abundance barplots {data-orientation=columns}
=====================================
...
<!-- ```{r eval=FALSE} -->
<!-- ggplotly(ancom_results$Class$plot) -->
<!-- ``` -->
...
<!-- ```{r eval=FALSE} -->
<!-- ggplotly(ancom_results$Order$plot) -->
<!-- ``` -->
...
<!-- ```{r eval=FALSE} -->
<!-- ggplotly(ancom_results$Family$plot) -->
<!-- ``` -->
...
<!-- ```{r eval=FALSE} -->
<!-- ggplotly(ancom_results$Genus$plot) -->
<!-- ``` -->
...
<!-- ```{r eval=FALSE} -->
<!-- ggplotly(ancom_results$Species$plot) -->
<!-- ``` -->
